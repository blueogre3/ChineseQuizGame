...
public class GameManager : MonoBehaviour {
    ...
    void Transition1()
    {
        SceneManager.LoadScene("Lvl1Completed");
    }
    ...
    private void TransitionRight()
    {
        ...
        PlayerPrefs.SetString("timetaken", timerLabel);
    ...
    public void Submit ()
    {
        ...
        InputField inputFieldCo = inputFieldGo.GetComponent<InputField>();
        scrollText.text += "\n";
        scrollText.text += inputFieldCo.text;
